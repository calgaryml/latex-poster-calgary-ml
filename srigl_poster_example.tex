...
\footercontent{
  ...
  Arxiv: 
  \begin{array}{l}
    \includesvg[height=3.5cm]{arxiv-qr.svg}
  \end{array}
  \hfill
  \centering
  ...
  CalgaryML Lab:
  \begin{array}{l}
    \includesvg[height=3.5cm]{calgaryml-qr.svg}
  \end{array}
}
...
% Colour logos
\logoright{
    \includegraphics[height=\logoheight]{iaifi-logo-black.pdf}
    \hspace{\logooffset}
    \includegraphics[height=\logoheight]{Vector-Institute_Logo.png}
    \hspace{\logooffset}
    \includesvg[height=\logoheight]{ucmllogo-text.svg}
    \hspace{\logooffset}
    \includesvg[height=\logoheight]{UC-horz-rgb.svg}
}
\logoleft{
    \includesvg[height=\logoheight]{upper_bound-black.svg}
    \hspace{\logooffset}
    \includesvg[height=\logoheight]{University_of_Guelph_logo.svg}
    \hspace{\logooffset}
    \includesvg[height=\logoheight]{MIT_logo-colour.svg}
    \hspace{\logooffset}
    \includesvg[height=\logoheight]{Google_2015_logo.svg}
}
...
\begin{column}{\colwidth}
  ...
  \begin{enumerate}
    ...
    \begin{figure}
        \includegraphics[width=.85\colwidth]{fig/constantfanin.pdf}
...
\begin{figure}
    \includegraphics[width=.5\colwidth]{fig/Theory_1.pdf}
...
\begin{figure}
    \begin{minipage}{.49\colwidth}
        \centering
        \includegraphics[width=0.49\colwidth]{fig/resnet50.pdf}
        \caption{ResNet-50/ImageNet}\label{fig:resnet50_acc_vs_sparsity}
    \end{minipage}
    \hfill
    \begin{minipage}{.49\colwidth}
        \centering
        \includegraphics[width=0.49\colwidth]{fig/vit.pdf}
...
\begin{figure}
    \begin{minipage}[t]{.49\colwidth}
        \centering
        \includegraphics[width=\linewidth]{fig/acc-vs-flops.pdf}
    ...
    \begin{minipage}[t]{.49\colwidth}
        \centering
        \includegraphics[width=\linewidth]{fig/CPU_benchmark.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\colwidth]{fig/ablationvsnoablation_wide.pdf}
...
\begin{figure}
    \begin{minipage}[t]{.48\colwidth}
        \includegraphics[width=0.49\colwidth]{fig/imagenet_perc_active.pdf}
        \caption{Neuron Ablation}\label{fig:imagenet_perc_active}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.48\colwidth}
        \includegraphics[width=0.48\colwidth]{fig/vit_rigl_fan_in.pdf}
